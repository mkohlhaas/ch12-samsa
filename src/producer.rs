...
mod tests {
    ...
    fn test_send_keyed() {
        ...
        let offset = producer
            .send_keyed("test.topic", "key1", b"value1")
            .unwrap();
        assert_eq!(offset, 0);

        let offset = producer
            .send_keyed("test.topic", "key2", b"value2")
            .unwrap();
        assert_eq!(offset, 1);
    }
    ...
    fn test_multiple_producers() {
        ...
        let offset1 = producer1
            .send_text("test.topic", "From Producer 1")
            .unwrap();
        let offset2 = producer2
            .send_text("test.topic", "From Producer 2")
            .unwrap();
